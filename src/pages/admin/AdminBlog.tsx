    ...
    <>
      ...
      {loading ? (
        ...
        <div className="py-20 text-center border border-white/[0.06]">
          <p className="text-white/20 text-[14px] mb-3">No blog posts yet.</p>
            ...
            <tbody>
              {posts.map(post => (
                <tr key={post.id} className="border-b border-white/[0.04] hover:bg-white/[0.02] transition-colors group">
                  ...
                  <td className="px-4 py-4 text-white/40 whitespace-nowrap">{post.category}</td>
                  <td className="px-4 py-4 text-white/40">{post.author_name}</td>
