    ...
    <>
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <h1 className="text-[24px] font-semibold text-white">Career Listings</h1>
        </div>
        <button
          onClick={openCreate}
      ...
      {loading ? (
        ...
        <div className="py-20 text-center border border-white/[0.06]">
          <p className="text-white/20 text-[14px] mb-3">No roles yet.</p>
            ...
            <tbody>
              {jobs.map(job => (
                <tr key={job.id} className="border-b border-white/[0.04] hover:bg-white/[0.02] transition-colors group">
                  ...
                  <td className="px-4 py-4 text-white/40 whitespace-nowrap">{job.workplace_type}</td>
                  <td className="px-4 py-4 text-white/40 truncate max-w-[160px]">{job.city}</td>
                  <td className="px-4 py-4">
                    <span className={cn(
