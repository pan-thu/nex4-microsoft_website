    ...
    <>
      ...
      <div className="flex flex-wrap items-start justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-[10px] uppercase tracking-[0.2em] text-white/25 font-semibold mb-1">Registrations</p>
          <h1 className="text-[22px] font-semibold text-white">{event.title}</h1>
        </div>
